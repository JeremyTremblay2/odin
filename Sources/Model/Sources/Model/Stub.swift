...
public func generateOdin() -> Odin {
    ...
    return Odin(withBlocs: [bloc1, bloc2], andUnits: [teachingUnit1, teachingUnit2, teachingUnit3, teachingUnit4, teachingUnit5, teachingUnit6, teachingUnit7])
}
